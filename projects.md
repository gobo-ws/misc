...
* **ola-trigger-dmx-hue-scene-bridge** - Run Philips Hue scenes on multiple bridges simultaneously *(unpublished, contact me if you are interested in a customized solution)*
...
* **[ola-trigger-yeelight-candela-light-dmx](https://github.com/gobo-ws/ola-trigger-elgato-key-light-dmx)** - Control Yeelight Candela BLE Light with DMX *(coming soon)*  
